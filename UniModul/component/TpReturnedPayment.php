...
class TpReturnedPayment extends TpPayment {
	...
	/**
	 * FIK value received from the EET system. NULL for payments without an EET
	 * receipt or when EET is disabled for the payment’s account.
	 *
	 * @var string|null
	 */
	protected $fik;
	...
	/**
	 * Computed BKP value sent to the EET system. NULL for payments without an
	 * EET receipt or when EET is disabled for the payment’s account.
	 *
	 * @var string|null
	 */
	protected $bkp;
	...
	/**
	 * Base64 encoded PKP signature sent to the EET system. NULL for payments
	 * without an EET receipt or when EET is disabled for the payment’s account.
	 *
	 * @var string|null
	 */
	protected $pkp;
	...
	/**
	 * URL of the EET web receipt. NULL for payments without an EET receipt or
	 * when EET or web receipts are disabled for the payment’s account.
	 *
	 * @var string|null
	 */
	...
	/**
	 * Result of the first communication try with the EET system. TRUE if the
	 * request succeeded, FALSE if it timed out. NULL if the request has not
	 * been processed yet, an error occured, when the payment doesn’t have an
	 * EET receipt, or when EET is disabled for the payment’s account.
	 *
	 * @var bool|null
	 */
	...
	protected static $OPTIONAL_ARGS = array(
		...
		'customerAccountName', 'fik', 'bkp', 'pkp', 'receiptUrl', 'firstSuccess'
	);
	/**
	...
	protected static $OPTIONAL_ARGS_DEFAULT = array(
		...
		'fik' => NULL, 'bkp' => NULL, 'pkp' => NULL, 'receiptUrl' => NULL,
		'firstSuccess' => NULL
	);
