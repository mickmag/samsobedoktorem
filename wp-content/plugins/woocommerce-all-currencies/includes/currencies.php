...
if ( ! function_exists( 'alg_wcac_get_crypto_currencies_names' ) ) {
	...
	function alg_wcac_get_crypto_currencies_names() {
		return array(
			'ADA'   => __( 'Cardano', 'woocommerce-all-currencies' ),
			'AUR'   => __( 'Auroracoin', 'woocommerce-all-currencies' ),
			'BNB'   => __( 'Binance Coin', 'woocommerce-all-currencies' ),
			'BTC'   => __( 'Bitcoin', 'woocommerce-all-currencies' ),
			'BCH'   => __( 'Bitcoin Cash', 'woocommerce-all-currencies' ),
			'BTK'   => __( 'Bitcoin Token', 'woocommerce-all-currencies' ),
			...
			'DRGN'  => __( 'Dragonchain', 'woocommerce-all-currencies' ),
			'EMC'   => __( 'Emercoin', 'woocommerce-all-currencies' ),
			'EOS'   => __( 'EOS', 'woocommerce-all-currencies' ),
			...
			'HT'    => __( 'Huobi Token', 'woocommerce-all-currencies' ),
			'IOT'   => __( 'IOTA', 'woocommerce-all-currencies' ),
			'LTC'   => __( 'Litecoin', 'woocommerce-all-currencies' ),
			'MARS'  => __( 'Marscoin', 'woocommerce-all-currencies' ),
			...
			'PAC'   => __( 'PACcoin', 'woocommerce-all-currencies' ),
			...
			'SMART' => __( 'SmartCash', 'woocommerce-all-currencies' ),
			...
			'USDT'  => __( 'Tether', 'woocommerce-all-currencies' ),
			'VTC'   => __( 'Vertcoin', 'woocommerce-all-currencies' ),
			'XLM'   => __( 'Stellar', 'woocommerce-all-currencies' ),
