...
<div  id="seo-redirection-msg">
   <i class="fa fa-times-circle"></i>Show & fix all broken links with our <a target="_blank" href="http://www.clogica.com/product/seo-redirection-premium-wordpress-plugin#404">SEO redirection Plugin</a> and improve your site SEO.
...
{
	localStorage.setItem('hide-seo-redirection-msg', 'y');
	document.getElementById("seo-redirection-msg").style.display = 'none'; 
}

if(localStorage.getItem('hide-seo-redirection-msg') == 'y')
{
	document.getElementById("seo-redirection-msg").style.display = 'none'; 
}
</script>
